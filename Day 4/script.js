...
console.log('3. Sort the inventory by birthdate, oldest to youngest');
...
console.table(inventors.reduce((acc, inventor) => acc + (inventor.passed-inventor.year), 0));
...
console.log(data);
console.log('8. Sub up the instances of each of these');
console.table(data.reduce((obj, word) => {
